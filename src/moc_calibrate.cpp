...
QT_INIT_METAOBJECT const QMetaObject CalibWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CalibWindow.data,
    qt_meta_data_CalibWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
